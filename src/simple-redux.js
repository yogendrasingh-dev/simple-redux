...
const connect = (mapStateToProps, mapDispatchToProps) => Component => {
	class Connect extends React.Component {
		...
		render() {
			...
			if (mapStateToProps === null || undefined) {
				mapStateToProps = () => {};
			}
			if (mapDispatchToProps === null || undefined) {
				mapDispatchToProps = () => {};
			}
			return (
	...
	return props => <ReduxContext.Consumer>{store => <Connect {...props} store={store} />}</ReduxContext.Consumer>;
};

const ReduxContext = React.createContext('simple_redux');
